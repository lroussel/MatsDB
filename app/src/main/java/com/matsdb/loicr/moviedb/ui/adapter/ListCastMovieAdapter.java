...
public class ListCastMovieAdapter extends ArrayAdapter<Cast> {

    private LayoutInflater inflater;
    private int castId;

    public ListCastMovieAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List<Cast> objects) {
