...
public class Movie {
    boolean adult, video;
    String backdrop_path, homepage, imbd_id, original_language, original_title, overview, poster_path, release_date, status, tagline, title;
    double budget, popularity, revenue, vote_average;
    int id, runtime, cote_count;
    List<Genre> genres;
    ...
    public int getCote_count() {
        return cote_count;
    }

    public void setCote_count(int cote_count) {
