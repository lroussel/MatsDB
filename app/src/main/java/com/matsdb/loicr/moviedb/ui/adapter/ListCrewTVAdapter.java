...
public class ListCrewTVAdapter extends ArrayAdapter<Crew> {

    private LayoutInflater inflater;
    private int crewId;

    public ListCrewTVAdapter(@NonNull Context context, @LayoutRes int resource, @NonNull List<Crew> objects) {
